...
/***/ "./src/ConfIt/product-schema.json":
/*!****************************************!*\
  !*** ./src/ConfIt/product-schema.json ***!
  \****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"title":"Product","version":1,"type":"object","properties":{"version":{"type":"number"},"price":{"type":"number"},"options":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"price":{"type":"number"},"displayName":{"type":"string"},"enabled":{"type":"boolean"},"componentIds":{"type":"array","items":{"type":"string"}}}}},"components":{"type":"array","items":{"allOf":[{"type":"object","properties":{"id":{"type":"string"},"displayName":{"type":"string"},"part":{"type":"string"},"text":{"type":"object","properties":{"placeholder":{"type":"string"},"fontFamily":{"type":"string"},"heightCenterRatio":{"type":"number"},"position":{"$ref":"#/$defs/vector3"},"scale":{"type":"number"},"upperCaseOnly":{"type":"boolean"},"maxLength":{"type":"number"}}},"material":{"type":"string"},"hex":{"type":"string"},"map":{"type":"string"},"mapRotation":{"type":"number"},"color":{"type":"string"},"colors":{"oneOf":[{"const":true},{"const":"solid"},{"type":"array","items":{"type":"string"}}]},"materialParams":{"type":"object","additionalProperties":true}}},{"$ref":"#/$defs/view"}]}},"materialForColors":{"type":"string"},"defaultColor":{"type":"string"},"colors":{"type":"array","items":{"type":"object","properties":{"name":{"type":"string"},"hex":{"type":"string"},"map":{"type":"string"},"repeat":{"type":"number"},"displayName":{"type":"string"},"metalness":{"type":"number"},"roughness":{"type":"number"}}}},"materials":{"type":"array","items":{"anyOf":[{"type":"object","properties":{"name":{"type":"string"},"complex":{"const":true},"params":{"type":"object","additionalProperties":true}}},{"type":"object","properties":{"name":{"type":"string"},"params":{"type":"object","tsType":"THREE.MeshStandardMaterialParameters"},"repeat":{"type":"number"}}}]}},"occlusionMap":{"type":"string"},"shadowCatcher":{"type":"object","properties":{"part":{"type":"string"},"texture":{"type":"string"}}},"preview":{"$ref":"#/$defs/view"},"inspirations":{"type":"array","items":{"$ref":"#/$defs/config"}},"snapshots":{"type":"array","items":{"allOf":[{"type":"object","properties":{"default":{"type":"string"}}},{"$ref":"#/$defs/view"}]}}},"$defs":{"vector3":{"type":"array","items":{"type":"number"},"minItems":3,"maxItems":3},"view":{"type":"object","properties":{"cameraPosition":{"$ref":"#/$defs/vector3"},"cameraTarget":{"$ref":"#/$defs/vector3"}}},"config":{"type":"object","properties":{"preview":{"type":"string"},"options":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"enabled":{"type":"boolean"}}}},"components":{"type":"array","items":{"type":"object","properties":{"id":{"type":"string"},"color":{"type":"string"},"textValue":{"type":"string"}}}}}}}}');
...
/* harmony export */   validateProductYaml: () => (/* binding */ validateProductYaml)
/* harmony export */ });
...
/* harmony import */ var _product_schema_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product-schema.json */ "./src/ConfIt/product-schema.json");
/* harmony import */ var _svelte_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./svelte-helper */ "./src/ConfIt/svelte-helper.ts");
...
function time(callback) {
  ...
  callback();
  (0,_svelte_helper__WEBPACK_IMPORTED_MODULE_2__.logg)("".concat(label, " took"), performance.now() - start);
}
var AppOptions = {
  devMode: __webpack_require__.g.location ? /(localhost|\d+\.\d+\.\d+\.\d+)/.test(location.hostname) : false
};
...
var ajv = new (ajv__WEBPACK_IMPORTED_MODULE_0___default())({
  ...
  keywords: ["tsType", "version"]
});
var validateProductYaml = ajv.compile(_product_schema_json__WEBPACK_IMPORTED_MODULE_1__);
})();
